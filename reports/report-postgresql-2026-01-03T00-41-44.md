...
**Generated:** 2026-01-03T00:46:46.940Z
**Dialect:** postgresql
**Mode:** Full Execution
...
| Skipped | 70 |
| Success rate | 81.6% |
| Execution time | 302176ms |

## Execution Failures

| Ruleblock | Target Table | Dependencies | Error |
|-----------|--------------|--------------|-------|
| rrt | rout_rrt | - | column "loc" does not exist |
| ckd_egfr_metrics | rout_ckd_egfr_metrics | - | column "egfr_l_dt" does not exist |
| ckd_uacr_metrics | rout_ckd_uacr_metrics | - | column "acr_l_dt" does not exist |
| dmg_loc | rout_dmg_loc | - | column "loc" does not exist |
| cd_hepb_coded | rout_cd_hepb_coded | - | column "hepb_icpc_code" does not exist |
| ckd_dense | rout_ckd_dense | - | operator does not exist: text = integer |
| ca_misc | rout_ca_misc | - | column "ca_att" does not exist |
| cd_dm_mx | rout_cd_dm_mx | cd_dm_dx | function substr(numeric, integer, integer) does not exist |
| cd_hepb | rout_cd_hepb | - | WITH query name "sq_e_ab" specified more than once |
| cd_nutr_low | rout_cd_nutr_low | - | column "wt_dt" does not exist |
| ckd_ttem | rout_ckd_ttem | - | column "rrt_dt_min" does not exist |
| dmg_loc2 | rout_dmg_loc2 | - | column "loc" does not exist |
| dmg_loc_origin | rout_dmg_loc_origin | - | column "loc" does not exist |
| pregnancy | rout_pregnancy | - | column "us_ld" does not exist |
| egfr_metrics | rout_egfr_metrics | - | column "egfr_rn_dt" does not exist |
| hba1c_graph | rout_hba1c_graph | cd_dm_dx | WITH query name "sq_hba1c_graph" specified more than once |
| rrt_hd_loc | rout_rrt_hd_loc | - | column "loc" does not exist |
| rrt_new3_wip | rout_rrt_new3_wip | - | column "loc" does not exist |
...
| 57 | cd_cardiac_af | cd_cardiac_vhd, cd_cardiac_cad, cd_cardiac_chf, cd_htn, cd_dm_dx, cd_cardiac_rx, cd_cardiac_ix | PASS |

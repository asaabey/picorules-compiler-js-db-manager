...
**Generated:** 2026-01-03T04:40:36.742Z
**Dialect:** mssql
**Mode:** Full Execution
...
| acr_metrics | SROUT_acr_metrics | - | The data types datetime and date are incompatible in the subtract operator. |
...
| dmg_loc | SROUT_dmg_loc | - | The substring function requires 3 argument(s). |
| cd_dm_dx | SROUT_cd_dm_dx | - | The data types datetime and date are incompatible in the subtract operator. |
| cd_htn | SROUT_cd_htn | - | The data types datetime and date are incompatible in the subtract operator. |
...
| dmg_loc_origin | SROUT_dmg_loc_origin | - | The substring function requires 3 argument(s). |

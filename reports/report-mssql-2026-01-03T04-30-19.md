...
**Generated:** 2026-01-03T04:32:15.334Z
**Dialect:** mssql
**Mode:** Full Execution
...
| acr_metrics | SROUT_acr_metrics | - | Incorrect syntax near '`'. |
...
| dmg_loc | SROUT_dmg_loc | - | Incorrect syntax near the keyword 'AS'. |
| dmg_hrn | SROUT_dmg_hrn | - | Incorrect syntax near '`'. |
| ckd_coded_dx | SROUT_ckd_coded_dx | - | Incorrect syntax near the keyword 'AS'. |
| cd_dm_dx | SROUT_cd_dm_dx | - | 'extract' is not a recognized built-in function name. |
| cd_htn | SROUT_cd_htn | - | Incorrect syntax near '`'. |
| cd_cardiac_cad | SROUT_cd_cardiac_cad | cd_cardiac_ix | Incorrect syntax near the keyword 'AS'. |
| cd_hepb_coded | SROUT_cd_hepb_coded | - | The label 'Negative' has already been declared. Label names must be unique within a query batch or stored procedure. |
| ckd_dense | SROUT_ckd_dense | - | The substring function requires 3 argument(s). |
...
| ipa_sep | SROUT_ipa_sep | - | Incorrect syntax near '`'. |
...
| dmg_loc2 | SROUT_dmg_loc2 | - | Case expressions may only be nested to level 10. |
| dmg_loc_origin | SROUT_dmg_loc_origin | - | Incorrect syntax near the keyword 'AS'. |
| egfr_metrics | SROUT_egfr_metrics | - | Invalid column name 'egfr60_last_dt'. |
| rrt_hd_loc | SROUT_rrt_hd_loc | - | Incorrect syntax near '`'. |
| rrt_new3_wip | SROUT_rrt_new3_wip | - | Incorrect syntax near the keyword 'AS'. |
